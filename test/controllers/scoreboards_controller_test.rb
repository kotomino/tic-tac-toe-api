...
class ScoreboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scoreboard" do
    assert_difference('Scoreboard.count') do
      post scoreboards_url, params: { scoreboard: { opoints: @scoreboard.opoints, xpoints: @scoreboard.xpoints } }, as: :json
    end
  ...
  test "should update scoreboard" do
    patch scoreboard_url(@scoreboard), params: { scoreboard: { opoints: @scoreboard.opoints, xpoints: @scoreboard.xpoints } }, as: :json
    assert_response 200
  end
